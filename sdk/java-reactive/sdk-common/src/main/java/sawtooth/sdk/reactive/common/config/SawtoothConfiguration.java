...
public class SawtoothConfiguration {
	...
	static {
		...
		System.setProperty(org.apache.logging.log4j.core.util.Constants.LOG4J_CONTEXT_SELECTOR, org.apache.logging.log4j.core.async.AsyncLoggerContextSelector.class.getName());
		if (LOGGER.isInfoEnabled())
