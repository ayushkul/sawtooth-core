...
public class DefaultSawtoothStateImpl implements SawtoothState {
  ...
  public Collection<String> setState(
    ...
    Future<Message> future =
        stream.send(mesgFact.getSetStateRequest(this.contextId, addressValuePairs));
  ...
  public ByteString AddEvent(String eventType, Map<String, String> attributes, ByteString extraData)
    ...
    Future<Message> future = stream.send(mesgFact.getEventAddRequest(this.contextId, eventType,
